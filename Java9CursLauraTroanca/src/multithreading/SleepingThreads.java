...
public class SleepingThreads extends Thread {
    ...
    @Override
     ...
     "We can put a thread on pause,"," using static sleep method,",
     " of class Thread.",
     ...
     for (String importantInfo1 : importantInfo) {
         ...
         System.out.println("I am SleepingThreads with thread ID: " + this.getId() + " and I am running :)");
         }
         catch (InterruptedException e) {
         //metoda sleep este intreruptibila.
         System.out.println("I am SleepingThreads with thread ID: " + this.getId() + " and I was interrupted :(( ");
         return;
         }
